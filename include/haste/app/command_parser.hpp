...
DEFINE_string(output_file, "", "Dump tracking states into a specified files.");
DEFINE_string(output_dir, "", "Dump tracking states into a specified directory per index.");
